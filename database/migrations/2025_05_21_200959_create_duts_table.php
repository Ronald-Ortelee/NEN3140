...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('duts', function (Blueprint $table) {
            ...
            $table->dateTime('date_in_use')->useCurrent()->comment('Known date when the DUT was brought into use');
            ...
            $table->unsignedBigInteger('safety_class_id')->nullable()->index('duts_safety_class_id_foreign');
